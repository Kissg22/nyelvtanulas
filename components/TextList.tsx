...
export default function TextList({items}:{items:TextItem[]}){const router=useRouter(); async function remove(id:string){if(!confirm('Biztosan törlöd ezt a szöveget?'))return; await fetch(`/api/texts/${id}`,{method:'DELETE'}); router.refresh();}
